...
if __name__ == '__main__':
    ...
    path = "/home/shtoshni/Research/hackathon_2019/tasks/probing/data/length_const"
    train_iter, val_iter, test_iter, num_labels = TaskDataset.iters(path, encoder, train_frac=0.1)
