...
class TaskDataset(Dataset):
    ...
    def __init__(self, path, model, train_frac=1.0,
        ...
        fields = [('text', text_field),
                  ('span1', Field(sequential=False, use_vocab=False, batch_first=True)),
                  ('span2', Field(sequential=False, use_vocab=False, batch_first=True)),
...
if __name__ == '__main__':
    ...
    path = "/home/shtoshni/Research/hackathon_2019/tasks/probing/data/word_const"
